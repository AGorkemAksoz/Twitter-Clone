...
class LoginViewController: UIViewController {
    ...
    private let loginTitleLabel: UILabel = {
        ...
        label.text = "Login to your accont"
    ...
    @objc private func didChangPasswordField() {
    ...
    private func bindViews() {
        ...
        passwordTextField.addTarget(self, action: #selector(didChangPasswordField), for: .editingChanged)
